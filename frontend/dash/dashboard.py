...
import frontend.dash.components.root as root
...
# from frontend.dash.components.plot_3d import plotly_graph, GRAPH_ID, MachinePlotter
from frontend.dash.components.example_tabs import controls, colors, buttons, graph
from objects.joint import Joint
import json
from models_definitions import arm_test, plane_test, circle_test, machine
from frontend.dash.pages.arm_page import ArmPage
from frontend.dash.pages.compound_model_page import CompoundModelPage
from frontend.dash.pages.plane_page import PlanePage
...
def setup_page(p_models=None):
    ...
    debug_textarea_p = dcc.Textarea(id=DEUBG_TEXT_ID_P, value="Debug code")
    debug_textarea_v = dcc.Textarea(id=DEUBG_TEXT_ID_V, value="Debug code")
...
def start_server(debug=True, port=8051):
